...
Before accepted in [Bioconductor](https://www.bioconductor.org/), `Hapi` can be downloaded and installed locally. The download link is [here](https://github.com/Jialab-UCR/Jialab-UCR.github.io/blob/master/Hapi_0.99.0.tar.gz).
